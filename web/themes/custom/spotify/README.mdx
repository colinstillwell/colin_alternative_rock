...
spotify theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of spotify theme and run the following commands:
`nvm use`
...
`drush en spotify -y`
`drush config-set system.theme default spotify -y`
